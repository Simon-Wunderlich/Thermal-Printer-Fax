...
class Renderer:
    ...
    def createBody(self, message):
        ...
        headerHeight = header.height if header is not None else 0
        totalHeight = headerHeight + textHeight + imgHeight
    ...
    def get_wrapped_text(
        self, text: str, font: PIL.ImageFont.ImageFont, line_length: int
    ):
        lines = [""]
